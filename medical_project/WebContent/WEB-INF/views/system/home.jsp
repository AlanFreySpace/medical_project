...
<title>个人画像</title><META Name="keywords" Content="个人画像" />

<link href="images/favicon.ico" rel="shortcut icon" type="image/x-icon">
<link href="../resources/admin/style/slick.css" rel="stylesheet">
<link href="../resources/admin/style/index_20200513.css" rel="stylesheet" type="text/css">
<link href="../resources/admin/style/news_index_416.css" rel="stylesheet" type="text/css">

<script src="../resources/admin/js/jquery.min.js" type="text/javascript"></script>
<script src="../resources/admin/js/slick.min.js"></script>
<script src="../resources/admin/js/comm.js" type="text/javascript"></script>
<!--Announced by Visual SiteBuilder 9-->
<link rel="stylesheet" type="text/css" href="../resources/admin/_sitegray/_sitegray_d.css" />
<script language="javascript" src="../resources/admin/_sitegray/_sitegray.js"></script>
<!-- CustomerNO:77656262657232300201465c -->
<link rel="stylesheet" type="text/css" href="index.vsb.css" />
<script type="text/javascript" src="../resources/admin/system/resource/js/counter.js"></script>
<script type="text/javascript">_jsq_(1001,'/index.jsp',-1,1623241808)</script>
</head>
<body>
...
<div class="header" id="header">
  ...
  <div class="navwrapper">
    ...
    <li><a href="../system/index1" title="医疗系统" class="">医疗系统</a>
    </li>
    <li><a href="xxgk.htm" title="医疗概况" class="">医疗概况</a>
        ...
        <ul>
            ...
            <li><a href="xxgk/tjzl.htm" title="统计资料">统计资料</a></li>
              
        </ul>
    </li>
    <li><a href="http://localhost:7474/browser/" title="医疗图谱" class="">医疗图谱</a>
    </li>
    ...
    <li><a href="kxyj.htm" title="科学研究" class="">科学研究</a>

        <ul>
            <li><a href="kxyj/kyxm1.htm" title="科研项目">科研项目</a></li>
            <li><a href="kxyj/kyjg1.htm" title="科研机构">科研机构</a></li>
            <li><a href="kxyj/kyhz1.htm" title="科研合作">科研合作</a></li>
            <li><a href="kxyj/kycgyzscq.htm" title="科研成果与知识产权">科研成果与知识产权</a></li>
            <li><a href="kxyj/xsjl1.htm" title="学术交流">学术交流</a></li>
...
<li><a href="#" target="_blank" title="" onclick="_addDynClicks(&#34;wburl&#34;, 1623241808, 36211)">医疗图书馆</a></li>
...
<form action="ssjgy.jsp?wbtreeid=1001" method="post" id="au3a" name="au3a" onsubmit="return _nl_ys_check()" style="display: inline">
 <input type="hidden" id="lucenenewssearchkey189089" name="lucenenewssearchkey" value=""><input type="hidden" id="_lucenesearchtype189089" name="_lucenesearchtype" value="1"><input type="hidden" id="searchScope189089" name="searchScope" value="1">
<input name="showkeycode" id="showkeycode189089" type="text" class="motion_1">
<button><i class="icon-search"></i></button>
</form><script language="javascript" src="../resources/admin/system/resource/js/base64.js"></script><script language="javascript" src="../resources/admin/system/resource/js/formfunc.js"></script>
...
<ul>
        <li style=" background-image:url(../resources/admin/images/newbg1.jpg)"><a href="https://mp.weixin.qq.com/s?src=11&timestamp=1592334060&ver=2404&signature=JEfsib*esKvUCOLalwuEvZCuPqE2dsXw5CU32hj9AgwgtGL1xpzfcM1mNNtdZN2PBJrdxuDIaeVNNlewX8cdJ5DvFbLA0RoOSfGXIzn*h9qkrxR1V6GyICChZCyy6cS7&new=1" target="_blank" title="【专题】AI进驻医疗保健">
    ...
    <li style=" background-image:url(../resources/admin/images/newbg2.jpg)"><a href="http://www.fudongli.com/zx/detail_1025.action" target="_blank" title="【专题】医疗升级，引进新材料">
    ...
    <li style=" background-image:url(../resources/admin/images/newbg3.jpg)"><a href="https://zhuanlan.zhihu.com/p/40027848" target="_blank" title="【专题】大数据改变医疗模式">
...
<a href="http://www.cmdi.org.cn/publish/default/" target="_blank" class="newsmore">更多医疗新闻</a><script>_showDynClickBatch(['dynclicks_u6_3881','dynclicks_u6_5125','dynclicks_u6_3880'],[3881,5125,3880],"wbnews", 1623241808)</script>
         ...
         <table align="center" style="margin-top:20px;">
            <tr>
                <td>
                        <a href="#" title="" onclick="_addDynClicks(&#34;wbimage&#34;, 1623241808, 56868)" target="_blank">
...
<div class="focus">
...
</div><script>_showDynClickBatch(['dynclicks_u8_5129','dynclicks_u8_5128','dynclicks_u8_5119','dynclicks_u8_4465','dynclicks_u8_4445','dynclicks_u8_4444'],[5129,5128,5119,4465,4445,4444],"wbnews", 1623241808)</script>
  ...
  <div class="section_3">
    <div class="tbg">
      <div><img alt="" src="../resources/admin/images/btbg.jpg"></div>
    </div>
    <div class="tcbg"></div>
    <div class="mainWrap relative">
    <h2><b></b>数据医疗<b></b></h2>
<div class="datawrapper">
  ...
  </div><script>_showDynClickBatch(['dynclicks_u9_4026','dynclicks_u9_4027','dynclicks_u9_4028','dynclicks_u9_4029','dynclicks_u9_4030','dynclicks_u9_4031','dynclicks_u9_4032','dynclicks_u9_4033','dynclicks_u9_4034','dynclicks_u9_4035','dynclicks_u9_4036','dynclicks_u9_4037','dynclicks_u9_4038','dynclicks_u9_4039','dynclicks_u9_4040','dynclicks_u9_4041','dynclicks_u9_4042','dynclicks_u9_4043','dynclicks_u9_4044','dynclicks_u9_4045','dynclicks_u9_4046','dynclicks_u9_4047','dynclicks_u9_4048','dynclicks_u9_4049'],[4026,4027,4028,4029,4030,4031,4032,4033,4034,4035,4036,4037,4038,4039,4040,4041,4042,4043,4044,4045,4046,4047,4048,4049],"wbnews", 1623241808)</script>
