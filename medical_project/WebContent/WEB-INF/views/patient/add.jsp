...
<div class="easyui-panel" title="添加" style="width:1200px;height:600px;">
...
<form id="add-form" method="post">
        <table cellspacing="10">
        	...
        	<tr>
                ...
                <td>
                	<select name="patientCategoryId" idField="id" treeField="name" class="easyui-combotree easyui-validatebox"  data-options="required:true,missingMessage:'请选择分类'" url="tree_list" panelHeight="256px" style="width:268px">  
                    </select>
                </td>
            </tr>
