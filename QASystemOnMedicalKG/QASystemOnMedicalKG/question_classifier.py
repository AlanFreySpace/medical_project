...
class QuestionClassifier:
    def __init__(self):
        ...
        # 加载特征词
        self.disease_wds= [i.strip() for i in codecs.open(self.disease_path,"r","utf-8") if i.strip()]
        self.department_wds= [i.strip() for i in codecs.open(self.department_path,"r","utf-8") if i.strip()]
        self.check_wds= [i.strip() for i in codecs.open(self.check_path,"r","utf-8") if i.strip()]
        self.drug_wds= [i.strip() for i in codecs.open(self.drug_path,"r","utf-8") if i.strip()]
        self.food_wds= [i.strip() for i in codecs.open(self.food_path,"r","utf-8") if i.strip()]
        self.producer_wds= [i.strip() for i in codecs.open(self.producer_path,"r","utf-8") if i.strip()]
        self.symptom_wds= [i.strip() for i in codecs.open(self.symptom_path,"r","utf-8") if i.strip()]
        ...
        self.deny_words = [i.strip() for i in codecs.open(self.deny_path,"r","utf-8") if i.strip()]
        # 构造领域actree
