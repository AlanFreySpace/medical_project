...
#dict_path = "C:\\Users\\youwd\\Desktop\\project\\medical_entity_recognize-master\\medical_entity_recognize-master\\prepare_data\\medical_ner_dict.csv"
dict_path = os.getcwd() + os.sep + "prepare_data" + os.sep + "medical_ner_dict.csv"
psgMax = PsegMax(dict_path)

c_root = os.getcwd() + os.sep + "prepare_data" + os.sep + "source_data" + os.sep
